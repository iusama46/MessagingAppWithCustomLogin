...
public class BloodBankHomeActivity extends AppCompatActivity {
    ...
    public void checkUser() {
        ...
        Query phoneQuery = FirebaseDatabase.getInstance().getReference(Constants.BLOOD_BANK).orderByChild(Constants.PHONE_NUMBER).equalTo(tempPhone);
        phoneQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                showProgress.hideProgress();
                Toast.makeText(BloodBankHomeActivity.this, databaseError.toException().getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void displayMsg(int code) {
        ...
        if (code == 0) {
            ...
            builder.setMessage("Your blood bank account is approved by administrator. Thank you for joining our community");
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setPositiveButton("SignIn", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    dialogInterface.dismiss();
                    startActivity(new Intent(BloodBankHomeActivity.this, MainActivity.class));
                    finish();
                }
            });
